...
import { getcarturl,clearcarturl,removeitemurl,getloginuserurl } from "./utils/constants";
            ...
            <div>
                ...
                <div className="bg-gray-100 h-screen ">
                    <div className="bg-gray-100 pt-10">
                        <img className="w-65 m-auto h-75 pt-5 " src={empty}></img>
                    </div>
                    <div className="font-bold text-xl text-center p-2">Your cart is empty</div>
                    <div className="text-center text-gray-600 pb-8">Go to home page and start building your cart now</div>
                    <Link to="/home">
        ...
        <div className="flex min-h-screen bg-gray-200">
            <div className="flex-1 px-10 py-6">
                <div className="max-w-4xl mx-auto space-y-4 ml-30">
                    {cart.map((item, index) => (
                        <div key={index} className="relative flex bg-white rounded-2xl shadow-md hover:shadow-xl transition overflow-hidden">
                            ...
                            <div className="flex-1 p-5 flex flex-col justify-between relative">
                                ...
                                <div className="flex justify-between items-center mt-4">
                                    ...
                                    <button onClick={()=>removeItem(item._id,loguser)} className="px-4 py-2 text-sm bg-red-400 text-white rounded-xl hover:bg-red-500 transition">Remove</button>
                                </div>
                            </div>
                        </div>
                    ))}
            ...
            <div className="w-1/4 bg-linear-to-b from-black to-gray-900 rounded-2xl p-6 shadow-2xl h-fit mt-6 mr-20">
                ...
                <Link to="/address"><button className="w-full mt-6 bg-red-400 text-white py-3 rounded-xl font-semibold hover:bg-red-500 hover:cursor-pointer transition flex items-center justify-center gap-2">
